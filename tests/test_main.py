...
class TestMain(TestCase):
    ...
    def test_help(self, select_effect_display_mock):
        ...
        select_effect_display_mock.assert_not_called()

    def test_version(self, select_effect_display_mock):
        result = self.runner.invoke(main.display_effects, ['--version'])
        self.assertEqual(result.exit_code, 0)
        self.assertIn("display-effects, version ", result.output)
        select_effect_display_mock.assert_not_called()

    def test_effect_list(self, select_effect_display_mock):
    ...
    def test_default_options_default_log(self, select_effect_display_mock):
        ...
        select_effect_display_mock.assert_called_once()

    def test_default_options_warning_log(self, select_effect_display_mock):
        result = self.runner.invoke(main.display_effects, ['--log-level', 'WARNING'])
        self.assertEqual(result.exit_code, 0)
        self.assertEqual(result.output, "")
        select_effect_display_mock.assert_called_once()

    def test_default_options_debug_log(self, select_effect_display_mock):
    ...
    def test_all_options_verbose_log(self, select_effect_display_mock):
    ...
    def test_invalid_effect_name(self, select_effect_display_mock):
    ...
    def test_invalid_effect_names(self, select_effect_display_mock):
